...
#               response time, and total timed-out requests) from a particular service on
#               your server for a specified period of time. The script generates a comma
#               separated values (CSV) file that you can either parse or open as a spreadsheet
#               (for example, in Microsoft Office or an equivalent application) for further analysis.
...
def main(argv=None):
    ...
    serverName = 'fm-ags0.fm.utah.edu'
    ...
    while fromTime == 0:
        ...
        fromTime = '2016-08-01 00:00' #Get input from user eventually - YYYY-MM-DD HH:MM format (e.g. 2014-05-10 14:00)
    ...
    # Ask for time interval in minutes
    #interval = int(raw_input("Time interval to report statistics (in minutes): "))
    interval= 1440 #one day

    # Ask for service name
    #If the service is nested in a folder, include the folder name (for example, Planning/FireHydrants.MapServer): ")
    serviceName = 'mapservices/coffee_shop_wm.MapServer'
